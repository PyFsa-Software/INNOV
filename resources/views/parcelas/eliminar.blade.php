            ...
            <form class="forms-sample" method="POST" action="{{route('parcelas.eliminar',$parcela)}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="descripcion_parcela" id="descripcion_parcela"
                        ...
                        value="{{old('descripcion_parcela', $parcela->descripcion_parcela)}}" autofocus disabled>
                </div>
                <div class="form-group">
                    <label for="exampleInputName1">Superficie</label>
                    <input type="text" class="form-control" name="superficie_parcela" id="nombreLote"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="manzana" id="superficieLote"
                        placeholder="Ingrese la manzana" value="{{old('manzana', $parcela->manzana)}}" disabled>
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword4">Cantidad de Bolsas de Cemento</label>
                    <input type="text" class="form-control" name="cantidad_bolsas" id="cantidadManzanas"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ancho" id="ubicacion" placeholder="Ingrese el ancho"
                        value="{{old('ancho', $parcela->ancho)}}" disabled>
                </div>
                <div class="form-group">
                    <label for="exampleInputCity1">Largo</label>
                    <input type="text" class="form-control" name="largo" id="ubicacion" placeholder="Ingrese el largo"
                        value="{{old('largo', $parcela->largo)}}" disabled>
                </div>
                <div class="form-group">
                    <label for="exampleInputCity1">Lote</label>
                    <select class="form-control" name="lote" id="lote" disabled>
                        <option value="0" selected disabled>Seleccione una opcion</option>
                        <option selected value="{{old('lote', $loteSeleccionado->id_lote)}}">{{old('lote',
                            $loteSeleccionado->nombre_lote)}}</option>
                    </select>
                </div>
